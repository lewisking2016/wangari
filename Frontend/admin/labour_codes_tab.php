...
<div class="admin-card" style="margin-bottom: 20px;">
    <h3 style="margin:0 0 16px;font-family:'Outfit',sans-serif;font-size:1.1rem;">Generate New Code</h3>
    <form method="POST" style="display:flex;gap:12px;flex-wrap:wrap;align-items:end;">
        ...
        <div style="flex:1;min-width:150px;">
            <label style="display:block;font-size:0.85rem;font-weight:600;color:#374151;margin-bottom:4px;">Max Uses</label>
            <input type="number" name="max_uses" value="10" min="1" max="100" style="width:100%;padding:10px;border:1px solid #E5E7EB;border-radius:8px;">
        </div>
        <div style="flex:1;min-width:150px;">
            <label style="display:block;font-size:0.85rem;font-weight:600;color:#374151;margin-bottom:4px;">Expires After (days)</label>
            <input type="number" name="expires_days" value="30" min="1" max="365" style="width:100%;padding:10px;border:1px solid #E5E7EB;border-radius:8px;">
        </div>
