    ...
    <div class="split-container">
        ...
        <div class="login-side">
            <div class="login-form-wrapper">
                ...
                <a href="/Frontend/auth/google/login.html" class="btn-login" style="display: flex; align-items: center; justify-content: center; gap: 12px; width: 100%; background: #000000; border: 1px solid #1e293b; color: #ffffff; text-decoration: none; font-size: 0.95rem; font-weight: 600; padding: 14px; border-radius: 999px; box-shadow: 0 4px 14px rgba(0,0,0,0.15); transition: all 0.2s ease;" onmouseover="this.style.background='#18181b'; this.style.boxShadow='0 6px 20px rgba(0,0,0,0.25)';" onmouseout="this.style.background='#000000'; this.style.boxShadow='0 4px 14px rgba(0,0,0,0.15)';">
