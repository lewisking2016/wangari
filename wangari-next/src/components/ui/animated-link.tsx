...
/* ── Link001: Underline slides left→right + arrow appears ── */
...
/* ── Link002: Underline slides right→left + arrow ── */
...
/* ── Link004: Highlight fill effect (mix-blend) + rotate arrow ── */
export const Link004 = ({
  ...
  return (
    ...
    >
      {children}
      <svg
        className="z-0 ml-[0.6em] size-[0.55em] translate-y-1 opacity-0 transition-all duration-300 group-hover:translate-y-0 group-hover:rotate-45 group-hover:opacity-100"
        fill="none"
        viewBox="0 0 10 10"
        xmlns="http://www.w3.org/2000/svg"
        aria-hidden="true"
...
/* ── Link005: Reverse highlight fill ── */
