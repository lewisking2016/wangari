...
/* ── Data ── */
const features = [
  { icon: Bird, title: "Livestock Management", desc: "Track all your farm animals from arrival to harvest. Monitor health, feeding, and production in real time.", href: "/features/flocks" },
